...
Original file is located at
    https://colab.research.google.com/drive/1AS_50KnPTeapNNMvbX-Py7kYxF7Tdo1_
"""

#-------------------------------------------------------------------------
# AUTHOR: Amanda Wong
# FILENAME: cnn.py
# SPECIFICATION: This program builds and trains a CNN or Convolutional Neural
# Network through the use of TensorFlow and Keras. The input into this program
# are 32 X 32 images of handwritten digits and the goal is to classify these
# images.
...
zip_path = '/content/digit_dataset.zip'
with zipfile.ZipFile('digit_dataset.zip', 'r') as zip_ref:
